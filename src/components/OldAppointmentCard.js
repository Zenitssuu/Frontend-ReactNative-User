...
const OldAppointmentCard = ({ appointment, borderColor }) => {
  const { _id, doctorDetails, behalfUserId, symptoms, date, isVisited } = appointment;
    ...
    <Card style={[styles.card, { borderColor: borderColor || "#F0F0F0" }]}>
      <Card.Content style={styles.cardContent}>
        ...
        <View style={styles.header}>
          ...
          {/* Visit Status Badge */}
          <View
            style={[styles.statusBadge, isVisited ? styles.visitedBadge : styles.notVisitedBadge]}
          >
            <MaterialCommunityIcons
              name={isVisited ? "check-circle" : "clock-outline"}
              size={14}
              color={isVisited ? "#28A745" : "#FFC107"}
            />
            <Text
              style={[styles.statusText, isVisited ? styles.visitedText : styles.notVisitedText]}
            >
